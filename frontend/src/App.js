                            ...
                            <div>
                                ...
                                <div className="relative mt-1">
                                    <input 
                                        ...
                                        id="password" 
                                        className="block w-full pr-10 border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 rounded-md shadow-sm focus:ring-orange-500 focus:border-orange-500 sm:text-sm p-3" 
                                        required 
                                    />
                                    <button
                                        type="button"
